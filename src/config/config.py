...
country_cfg = Config.configure_data_node(
    id="country", default_data="France", validity_period=dt.timedelta(days=5)
)


date_cfg = Config.configure_data_node(
    id="date",
    default_data=dt.datetime(2020, 10, 1),
    validity_period=dt.timedelta(days=5),
)

final_data_cfg = Config.configure_data_node(
    id="final_data", validity_period=dt.timedelta(days=5)
)

train_data_cfg = Config.configure_data_node(
    id="train_data", validity_period=dt.timedelta(days=5)
)

model_arima_cfg = Config.configure_data_node(
    id="model_arima", validity_period=dt.timedelta(days=5)
)
model_linear_regression_cfg = Config.configure_data_node(
    id="model_linear_regression", validity_period=dt.timedelta(days=5)
)

predictions_arima_cfg = Config.configure_data_node(id="predictions_arima")
predictions_linear_regression_cfg = Config.configure_data_node(
    id="predictions_linear_regression"
)
...
task_train_arima_cfg = Config.configure_task(
    id="task_train", function=train_arima, input=train_data_cfg, output=model_arima_cfg
)
...
task_train_linear_regression_cfg = Config.configure_task(
    id="task_train_linear_regression",
    function=train_linear_regression,
    input=train_data_cfg,
    output=model_linear_regression_cfg,
)

task_forecast_linear_regression_cfg = Config.configure_task(
    id="task_forecast_linear_regression",
